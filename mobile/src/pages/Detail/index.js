...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" com o valor de ${valueFormated}.`;
    ...
    function sendWhatsApp() {
        let whatsapp = incident.whatsapp;
        if (!whatsapp.startsWith(55)) {
            whatsapp = '55'+incident.whatsapp;
        }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.headerButton} onPress={navigateToIncidents}>
